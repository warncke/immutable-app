...
const defaultGlobalConfig = {
    ...
    assets: {
        // list of linked css resources that will be rendered as link tags
        css: [
            {
                crossorigin: 'anonymous',
                integrity: 'sha256-eZrrJcwDc/3uDhsdt61sL2oOBY362qM3lon1gyExkL0=',
                href: '//cdn.jsdelivr.net/fontawesome/4.7.0/css/font-awesome.min.css',
            },
            {
                crossorigin: 'anonymous',
                href: '//cdn.jsdelivr.net/g/pure@0.6.2(pure-min.css+grids-responsive-min.css)',
            },
            {
        ...
        include: [],
        // list of linked javascript resources that will be rendered with src
        js: [
            {
                crossorigin: 'anonymous',
            ...
            {
                crossorigin: 'anonymous',
                integrity: 'sha256-IyWBFJYclFY8Pn32bwWdSHmV4B9M5mby5bhPHEmeY8w=',
                src: '//cdn.jsdelivr.net/lodash/4.17.4/lodash.min.js',
            },
            {
                src: '/assets/base.js',
            },
        ...
        // data properties that will be set on window
        window: {},
    },
